...
public class Practica4_LópezTorrecilla_Daniel {
	...
	private static void cambio() {
		System.out.println("Por favor, seleccione la moneda de la que desea modificar el cambio: 1-Euros=Dólares 2-Bitcoin=Euros 3-Bitcoin=Dólares");
		int seleccion1;
		Scanner teclado1 = new Scanner (System.in);
		seleccion1 = teclado1.nextInt();
		System.out.println("Indique su selección nueva: ");
		int seleccion2;
	...
	private static void multiplicar(String seleccion3, double seleccion4, String seleccion5) {
	...
	private static void dividir(String seleccion3, double seleccion4, String seleccion5) {
	...
	private static void conversion() {
		...
		if(seleccion3.equalsIgnoreCase("€") && seleccion5.equalsIgnoreCase("$")) {
			multiplicar(seleccion3, seleccion4, seleccion5);
			...
			dividir(seleccion3, seleccion4, seleccion5);
	...
	public static void main(String[] args) {
		...
		do{
			System.out.println("¿Qué desea realizar? 1.Modificar el cambio de monedas 2.Realizar conversión entre monedas 3.Salir");
			System.out.println("Indique su selección:");
