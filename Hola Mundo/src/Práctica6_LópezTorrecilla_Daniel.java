...
public class Práctica6_LópezTorrecilla_Daniel {
	...
	public static void main(String[] args) {
		...
		System.out.println("El número más grande es: " +mayor(array));
		
		System.out.println("El número más pequeño es: " +menor(array));
